...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RockSelect = __webpack_require__(160);

	var _RockSelect2 = _interopRequireDefault(_RockSelect);

	var _optionsData = __webpack_require__(161);
	...
	_reactDom2.default.render(_react2.default.createElement(
	  'div',
	  null,
	  _react2.default.createElement(_RockSelect2.default, { options: _optionsData.DATA, defaultValue: 'Fruts', generalClick: foo, iconClass: 'icon-css' }),
	  _react2.default.createElement(_RockSelect2.default, { options: _optionsData.DATA2, defaultValue: 'Speed', iconClass: 'icon-instructions' }),
	  _react2.default.createElement(_RockSelect2.default, { options: _optionsData.DATA3, iconClass: 'icon-sound' }),
	  _react2.default.createElement(_RockSelect2.default, { options: ['One', 'Two', 'Three'], defaultValue: 'Default>', generalClick: foo, iconClass: 'icon-code' })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CLASS_ALIAS = 'RockMenu';

	var RockSelect = function (_Component) {
	  _inherits(RockSelect, _Component);

	  function RockSelect(props) {
	    _classCallCheck(this, RockSelect);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(RockSelect).call(this, props));

	    var METHODS = ['toggleOptions', 'onClickOption', 'initOption'];
	  ...
	  _createClass(RockSelect, [{
	    ...
	    value: function initOption() {
	      ...
	      } else if (_typeof(this.props.options[0]) === 'object') {
	        this.optionSelected = this.props.options[0].value;
	      }
	    }
	  }, {
	    key: 'onClickOption',
	    value: function onClickOption(event) {
	      ...
	      if (typeof this.props.options[0] === 'string') {
	        return this.props.options.map(function (option) {
	          return _react2.default.createElement(
	            'div',
	            { key: option, className: _this2.classes.option },
	            _react2.default.createElement(
	              'div',
	              { onClick: _this2.onClickOption, className: CLASS_ALIAS + '__option__name' },
	              option
	            )
	          );
	        });
	        ...
	        return this.props.options.map(function (option) {
	          return _react2.default.createElement(
	            'div',
	            { key: option.value, className: _this2.classes.option },
	            _react2.default.createElement(
	              'div',
	              { onClick: _this2.onClickOption, className: CLASS_ALIAS + '__option__name' },
	              option.value
	    ...
	    value: function render() {
	      var ICON = this.props.iconClass ? CLASS_ALIAS + '__selected__ico ' + this.props.iconClass : CLASS_ALIAS + '__selected__ico';
	      return _react2.default.createElement(
	        'div',
	        { className: '' + CLASS_ALIAS },
	        _react2.default.createElement('div', { className: CLASS_ALIAS + '__line' }),
	        _react2.default.createElement(
	          'div',
	          { className: this.classes.selected, onClick: this.toggleOptions },
	          _react2.default.createElement('div', { className: ICON }),
	          _react2.default.createElement(
	            'div',
	            { className: CLASS_ALIAS + '__selected__name' },
	            this.optionSelected
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          { style: this.optionsVisible },
	          this.renderOptions()
	        )
	      );
	    }
